...
insert into desecho_movimientos (posttime, responsible_name, ubicacion_id, recolector_id, productor_id, ev_id, tipomov_id, tiporec_id, reci_desecho_cantidad, user_id, computer,[user], proceso_id) values ('2023-04-30 07:45:00', 'Karla Sanchez', 1, 4, 3, 1, 1, 1, 0.6, 1, 'localhost', 'root', 6);
