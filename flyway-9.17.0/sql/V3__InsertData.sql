...
DBCC CHECKIDENT(ciudades, RESEED, 1);
...
DBCC CHECKIDENT(paises, RESEED, 1);
...
DBCC CHECKIDENT(ubicaciones, RESEED, 1);
...
DBCC CHECKIDENT(regiones, RESEED, 1);
...
DBCC CHECKIDENT(tipo_desecho, RESEED, 1);
...
DBCC CHECKIDENT(desechos, RESEED, 1);
...
DBCC CHECKIDENT(tipo_contactos, RESEED, 1);
...
DBCC CHECKIDENT(actores, RESEED, 1);
...
DBCC CHECKIDENT(contacto_value, RESEED, 1);
...
DBCC CHECKIDENT(productores_residuos, RESEED, 1);
...
-- falta correr
DBCC CHECKIDENT(recolectores, RESEED, 4);
...
DBCC CHECKIDENT(local_ev, RESEED, 1);
...
DBCC CHECKIDENT(tipo_movimiento, RESEED, 1);
...
DBCC CHECKIDENT(tipo_recipientes, RESEED, 1);
...
DBCC CHECKIDENT(contrato, RESEED, 10);
...
DBCC CHECKIDENT(proceso, RESEED, 4);
...
insert into proceso (volumen, clasificacion, ev_id, fecha, estado, costo, contrato_id) values (670000.00, 1, 5, '2022-02-13 09:45:00','terminado', 1500000, 11);

DBCC CHECKIDENT(desecho_movimientos, RESEED, 7);
...
DBCC CHECKIDENT(recursos_materiales, RESEED, 4);
...
DBCC CHECKIDENT(materiales_para_producto, RESEED, 4);
...
DBCC CHECKIDENT(productos, RESEED, 2);
...
DBCC CHECKIDENT(productos_producidos, RESEED, 1);
